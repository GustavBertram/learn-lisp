;;;; WEB DICE OF DOOM V2
;;; Contains code from Land of Lisp Ch 20.
;;; Final update of Dice of Doom.
;;; (CLISP only)

(load "19_webdice.lisp")
...
;; Calling the dice rolling code from the game engine
