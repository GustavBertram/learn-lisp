;;;; WEB DICE OF DOOM
;;; Contains code from Land of Lisp Ch 19.
;;; Updating Dice of Doom with a web interface.
;;; (CLISP only)

(load "13_web_server.lisp")
(load "18_doom_dice_v2.lisp")
(load "17_dsl.lisp")

;; Redefine svg macro as per errata
