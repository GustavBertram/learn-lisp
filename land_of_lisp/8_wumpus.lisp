...
;;; Build Final Edges for the City, Add Roadblocks
...
;;; Starting the Game, drawing the city
  ...
  (mapcar (lambda (node)
          ...
          (remove-duplicates
           (append *visited-nodes*
                   (mapcan (lambda (node) ; MAPCAN appends the converted list
                             (mapcar #'car
                                     (cdr (assoc node *congestion-city-edges*))))
                           *visited-nodes*)))))

(defun known-city-edges ()
  (mapcar (lambda (node) ; MAPCAR converts the list
